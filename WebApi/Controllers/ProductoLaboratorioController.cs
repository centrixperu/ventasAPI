...
namespace WebApi.Controllers
{
    ...
    [RoutePrefix("api/ProdLaboratorio")]
    public class ProductoLaboratorioController : ApiController
    {
        ...
        public IHttpActionResult GetDatosIniciales(string usuario, int idCliente)
        {
            try
            {
                ProductoLaboratorioBL oProductoLaboratorioBL = new ProductoLaboratorioBL(idCliente);
                ProductoLaboratorio_DatosInicialesBE lobe = oProductoLaboratorioBL.ListarDatosIniciales(usuario, idCliente);
        ...
        [Route("Guardar")]
        [HttpPost]
        public async Task<IHttpActionResult> Guardar(ProductoLaboratorioBE obe)
        {
            try
            {
                ProductoLaboratorioBL oProductoLaboratorioBL = new ProductoLaboratorioBL(obe.IdCliente);
                bool rpta = false;
                rpta = oProductoLaboratorioBL.Guardar(obe);
        ...
        [Route("Actualizar")]
        [HttpPost]
        public async Task<IHttpActionResult> Actualizar(ProductoLaboratorioBE obe)
        {
            try
            {
                ProductoLaboratorioBL oProductoLaboratorioBL = new ProductoLaboratorioBL(obe.IdCliente);
                bool rpta = false;
                rpta = oProductoLaboratorioBL.Actualizar(obe);
        ...
        public async Task<IHttpActionResult> Eliminar(int Id, int IdCliente, string UsrModificador)
        {
            try
            {
                ...
                bool rpta = false;
                rpta = oProductoLaboratorioBL.Eliminar(obe);
